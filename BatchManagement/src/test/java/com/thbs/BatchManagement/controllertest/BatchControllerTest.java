...
public class BatchControllerTest {
    ...
    public void testAddEmployeesToExistingBatchesBulkUpload() throws IOException, BatchNotFoundException, DuplicateEmployeeException {
        ...
        public void testGetEmployeesInBatch() {
            ...
            List<Integer> response = batchController.getEmployeesInBatch(batchId);
        ...
        public void testGetEmployeesInBatchByName() {
            ...
            List<Integer> response = batchController.getEmployeesInBatchByName(batchName);
...
//
//            String expectedResponse = "BatchName updated successfully";
//            when(batchService.updateBatchName(id, batch.getBatchName())).thenReturn(expectedResponse);
//
